...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a class="navbar-brand" href="#">Логотип школы</a>
            </div>

            <div class="collapse navbar-collapse js-navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="dropdown mega-dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Школа</a>				
                        <ul class="dropdown-menu mega-dropdown-menu">
                            <li class="col-sm-3">
                                <ul>
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="#">Подробнее <span class="glyphicon glyphicon-chevron-right pull-right"></span></a></li>
                                </ul>
                            </li>
                            <li class="col-sm-3">
                            <ul>
